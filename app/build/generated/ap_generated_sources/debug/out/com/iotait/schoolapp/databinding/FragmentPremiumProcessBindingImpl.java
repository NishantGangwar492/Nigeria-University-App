...
public class FragmentPremiumProcessBindingImpl extends FragmentPremiumProcessBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_buy_p1, 3);
        sViewsWithIds.put(R.id.tvlearnmore2, 4);
        sViewsWithIds.put(R.id.btn_buy_p2, 5);
    }
    // views
    @NonNull
    ...
    public FragmentPremiumProcessBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentPremiumProcessBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
