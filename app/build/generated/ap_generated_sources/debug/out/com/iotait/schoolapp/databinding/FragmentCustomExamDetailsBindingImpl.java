...
public class FragmentCustomExamDetailsBindingImpl extends FragmentCustomExamDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_total_question, 3);
        sViewsWithIds.put(R.id.layout_timer, 4);
        sViewsWithIds.put(R.id.txt_remaining_time, 5);
        sViewsWithIds.put(R.id.rvquestions, 6);
    ...
    public FragmentCustomExamDetailsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private FragmentCustomExamDetailsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
