...
public class FragmentExamPreviewBindingImpl extends FragmentExamPreviewBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvquestions, 2);
        sViewsWithIds.put(R.id.btn_submit, 3);
    }
    // views
    @NonNull
    ...
    public FragmentExamPreviewBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentExamPreviewBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
