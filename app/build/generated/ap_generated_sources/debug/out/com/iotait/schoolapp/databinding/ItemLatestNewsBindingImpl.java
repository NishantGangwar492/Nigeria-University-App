...
public class ItemLatestNewsBindingImpl extends ItemLatestNewsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imageoverview, 3);
    }
    // views
    @NonNull
    ...
    public ItemLatestNewsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ItemLatestNewsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textoverview, newsitemGetPostTitle);
        }
    }
