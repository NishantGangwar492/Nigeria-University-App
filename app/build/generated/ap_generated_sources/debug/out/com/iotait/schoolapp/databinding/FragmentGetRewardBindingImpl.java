...
public class FragmentGetRewardBindingImpl extends FragmentGetRewardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.pointsinmycoin, 3);
        sViewsWithIds.put(R.id.earnMorePoints, 4);
    }
    // views
    @NonNull
    ...
    public FragmentGetRewardBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentGetRewardBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
