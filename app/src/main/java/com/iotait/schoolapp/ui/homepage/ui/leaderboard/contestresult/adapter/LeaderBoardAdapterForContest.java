package com.iotait.schoolapp.ui.homepage.ui.leaderboard.contestresult.adapter;
...
public class LeaderBoardAdapterForContest extends RecyclerView.Adapter<LeaderBoardAdapterForContest.ViewHolder> {

    Context context;
    List<LeaderBoardModel> leaderBoardModelList;
    LeaderBoardView leaderBoardView;

    public LeaderBoardAdapterForContest(Context context, List<LeaderBoardModel> leaderBoardModelList, LeaderBoardView leaderBoardView) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                leaderBoardView.OnLeaderBoardItemClickWeeklyContestTop(leaderBoardModel);
            }
        });
        int pos = position + 1;
