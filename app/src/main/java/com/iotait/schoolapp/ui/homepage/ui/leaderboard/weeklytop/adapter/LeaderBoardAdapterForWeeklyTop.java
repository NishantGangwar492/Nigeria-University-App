package com.iotait.schoolapp.ui.homepage.ui.leaderboard.weeklytop.adapter;
...
public class LeaderBoardAdapterForWeeklyTop extends RecyclerView.Adapter<LeaderBoardAdapterForWeeklyTop.ViewHolder> {

    Context context;
    List<LeaderBoardModel> leaderBoardModelList;
    LeaderBoardView leaderBoardView;

    public LeaderBoardAdapterForWeeklyTop(Context context, List<LeaderBoardModel> leaderBoardModelList, LeaderBoardView leaderBoardView) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                leaderBoardView.OnLeaderBoardItemClickWeeklyTop(leaderBoardModel);
            }
        });
        int pos = position + 1;
