package com.iotait.schoolapp.ui.homepage.ui.leaderboard.monthlytop.adapter;
...
public class LeaderBoardAdapterForMonthlyTop extends RecyclerView.Adapter<LeaderBoardAdapterForMonthlyTop.ViewHolder> {

    Context context;
    List<LeaderBoardModel> leaderBoardModelList;
    LeaderBoardView leaderBoardView;

    public LeaderBoardAdapterForMonthlyTop(Context context, List<LeaderBoardModel> leaderBoardModelList, LeaderBoardView leaderBoardView) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                leaderBoardView.OnLeaderBoardItemClickMonthlyTop(leaderBoardModel);
            }
        });
        int pos = position + 1;
